...
NUM_POSTS_TO_SCRAPE: int = 5  # Set to 0 if you want all posts
...
class BaseSubstackScraper(ABC):
    def __init__(self, base_substack_url: str, md_save_dir: str, html_save_dir: str, start_date: Optional[datetime] = None):
    ...
    def scrape_posts(self, num_posts_to_scrape: int = 0) -> None:
        ...
        count = 0
        processed = 0
        # Only process first 5 non-premium URLs
        target = 5 if num_posts_to_scrape == 0 else num_posts_to_scrape
        
        print(f"Processing latest {target} non-premium posts...")
        for url in tqdm(self.post_urls):
            ...
            try:
                ...
                if soup is None:  # Skip premium articles
                    continue
...
class SubstackScraper(BaseSubstackScraper):
    def __init__(self, base_substack_url: str, md_save_dir: str, html_save_dir: str, start_date: Optional[datetime] = None):
        super().__init__(base_substack_url, md_save_dir, html_save_dir, start_date)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help='Scrape posts from this date forward (YYYY-MM-DD)'
    )
